<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.activities.index')" :active="request()->routeIs('admin.activities.*')">
                        {{ __('Activities & Checklists') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.users.index')" :active="request()->routeIs('admin.users.*')">
                        {{ __('Users') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.kit-codes.index')" :active="request()->routeIs('admin.kit-codes.*')">
                        {{ __('Kit Codes') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.kit-codes.index')" :active="request()->routeIs('admin.kit-codes.*')">
                {{ __('Kit Codes') }}
            </x-responsive-nav-link>
