...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Get next available code for module
    Route::get('/modules/{module}/next-code', [UserModuleController::class, 'getNextCode'])->name('modules.next-code');
...
// Admin routes
    ...
    Route::post('kit-codes/bulk-delete', [AdminKitCodeController::class, 'bulkDelete'])->name('kit-codes.bulk-delete');
